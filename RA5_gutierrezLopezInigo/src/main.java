...
public class main {
	...
	public static void main(String[] args) {
		...
		restaurant.empleados[0] = new Empleado("Sara",Empleado.Trabajo.CAMARERO);
		restaurant.empleados[1] = new Empleado("Daniel",Empleado.Trabajo.CAMARERO);
		restaurant.empleados[2] = new Empleado("Jesus",Empleado.Trabajo.CAMARERO);
		restaurant.empleados[3] = new Empleado("Susana",Empleado.Trabajo.COCINERO);
		restaurant.empleados[4] = new Empleado("Andres",Empleado.Trabajo.COCINERO);
		...
		do{
			try {
				...
				if(op == 1) {
					...
					System.out.println("Su mesa es la "+num);
				}else if(op == 2) {
