...
public class ejercicio3igl {
    public static void main(String[] args) {
     ...
     // Variables 
        ...
        numeroAlumnos = EntradaDatos(sc, numeroAlumnos);

        AlumnosNotas(sc, nombreAlumno, numeroAlumnos, sumaNotas);

    }

	private static void AlumnosNotas(Scanner sc, String nombreAlumno, int numeroAlumnos, double sumaNotas) {
		double notaT1;
		double notaT2;
		double notaT3;
		double notaT4;
	...
	private static int EntradaDatos(Scanner sc, int numeroAlumnos) {
